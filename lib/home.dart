    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          therapy(() {
            print(pfp);
          }, "Music Therapy", Color(0xFFFCD3E1), Color(0xFFF15858),
              Icons.music_note),
          therapy(() {
            navigateTo(context, InspirationTherapy());
          }, "Inspiration Therapy", Color(0xFFC4E6FF), Color(0xFF2D9AED),
              Icons.lightbulb),
          therapy(() async {
            await launch(expression);
          }, "Expression Therapy", Color(0xFFFEDDBA), Color(0xFFE4852C),
              Icons.message),
          therapy(() {}, "Virtual Forest", Color(0xFFD3EA9C), Color(0xFF75B322),
              Icons.park),
          Expanded(
            flex: 1,
            child: Container(
